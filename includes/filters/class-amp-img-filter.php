...
require_once( __THEME__DIR__ . '/includes/filters/class-amp-base-filter.php' );
require_once( __THEME__DIR__ . '/includes/utils/class-amp-image-dimension-extractor.php' );
