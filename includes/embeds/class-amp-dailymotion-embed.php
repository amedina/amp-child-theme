...
require_once( __THEME__DIR__ . '/includes/embeds/class-amp-base-embed-handler.php' );
...
class AMP_DailyMotion_Embed_Handler extends AMP_Base_Embed_Handler {
	...
	// When the content filter is executed, it will process the embeds and shortcodes
